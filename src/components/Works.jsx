...
import { useMediaQuery } from 'react-responsive'; // Import react-responsive package
...
const ProjectCard = ({ index, name, description, tags, image, source_code_link, project_url }) => {
...
const Works = () => {
	...
	return (
		<>
			{/* Conditionally render animation variants based on screen size */}
			{isSmallScreen ? (
				<div>
